FavesRUS.dataAccess = (function() {

	// Options input parameter will have all the data
	// needed to perform the ajax call
			...
			error: function (xhr, status, errorThrown) {
				...
				switch (xhr.status) {
					...
					case '500':
						...
						break;
					default:
						alert('Unexpected error: ' + errorThrown + "  " + status);
                        break;
				}
