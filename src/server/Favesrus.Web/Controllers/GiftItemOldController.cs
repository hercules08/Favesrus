...
{
    public class GiftItemOldController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,ItemName,ItemImage,ItemPrice,Description")] GiftItem giftitem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ItemName,ItemImage,ItemPrice,Description")] GiftItem giftitem)
        {
            if (ModelState.IsValid)
            {
