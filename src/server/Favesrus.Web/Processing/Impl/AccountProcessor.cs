            ...
            if (user == null) // User is not registered
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    try
                    {
                        ...
                        Emailer.SendEmail(FavesrusConstants.EMAIL_ADDRESS, "Confirm Faves 'R' Us Account", "Please confirm your Faves account by clicking <a href=\"" + callbackUrl + "\">here</a>", user.Email);
